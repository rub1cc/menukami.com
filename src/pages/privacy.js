    ...
    <div className="bg-white">
      ...
      <DesktopLayout>
        <div>
          ...
          <h1 className="text-3xl mt-8 font-medium">Interpretation and Definitions</h1>
          ...
          <ul className="space-y-4 py-4">
            ...
            <li className="ml-8 list-disc">
              <p>
                ...
                in this Agreement) refers to Menukami.
              </p>
            </li>
            <li className="ml-8 list-disc">
              <p>
            ...
            <li className="ml-8 list-disc">
              <p>
                <strong>Website</strong> refers to Menukami, accessible from{' '}
                <a
          ...
          <h1 className="text-3xl mt-8 font-medium">Collecting and Using Your Personal Data</h1>
          <h2 className="text-2xl mt-4">Types of Data Collected</h2>
          <h3 className="text-xl mt-4">Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl mt-4">Usage Data</h3>
          ...
          <h3 className="text-xl mt-4">Information from Third-Party Social Media Services</h3>
          <p>
          ...
          <ul className="space-y-4 py-4">
            <li className="ml-8 list-disc">Google</li>
            <li className="ml-8 list-disc">Facebook</li>
            <li className="ml-8 list-disc">Twitter</li>
          </ul>
          <p>
          ...
          <h3 className="text-xl mt-4">Tracking Technologies and Cookies</h3>
          <p>
          ...
          <ul className="space-y-4 py-4">
            ...
            <li className="ml-8 list-disc">
              ...
              Flash Cookies, please read "Where can I change the settings for disabling, or deleting
          ...
          <h2 className="text-2xl mt-4">Use of Your Personal Data</h2>
          ...
          <h2 className="text-2xl mt-4">Retention of Your Personal Data</h2>
          <p>
          ...
          <h2 className="text-2xl mt-4">Transfer of Your Personal Data</h2>
          <p>
          ...
          <h2 className="text-2xl mt-4">Disclosure of Your Personal Data</h2>
          <h3 className="text-xl mt-4">Business Transactions</h3>
          <p>
          ...
          <h3 className="text-xl mt-4">Law enforcement</h3>
          <p>
          ...
          <h3 className="text-xl mt-4">Other legal requirements</h3>
          <p>
            The Company may disclose Your Personal Data in the good faith belief that such action is
            necessary to:
          </p>
          <ul className="space-y-4 py-4">
            <li className="ml-8 list-disc">Comply with a legal obligation</li>
            <li className="ml-8 list-disc">
            ...
            <li className="ml-8 list-disc">Protect against legal liability</li>
          </ul>
          <h2 className="text-2xl mt-4">Security of Your Personal Data</h2>
          <p>
          ...
          <h1 className="text-3xl mt-8 font-medium">Children's Privacy</h1>
          <p>
          ...
          <h1 className="text-3xl mt-8 font-medium">Links to Other Websites</h1>
          <p>
          ...
          <h1 className="text-3xl mt-8 font-medium">Changes to this Privacy Policy</h1>
          <p>
          ...
          <h1 className="text-3xl mt-8 font-medium">Contact Us</h1>
          <p>If you have any questions about this Privacy Policy, You can contact us:</p>
          <ul className="space-y-4 py-4">
            <li className="ml-8 list-disc">By email: cs@menukami.com</li>
          </ul>
        </div>
      </DesktopLayout>
      <HomeFooter />
